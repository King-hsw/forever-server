...
/**
 * 动态管理端：发布/删除/媒体上传。
 * 发布与上传需 moment:post 权限码；删除仅登录，删除在 Service 内再校验作者或 ADMIN。
 */
@Tag(name = "动态管理", description = "发布/删除动态、媒体上传，需 JWT 认证")
@RestController
...
public class AdminMomentController {
    ...
    @Operation(summary = "删除动态", description = "仅作者本人或 ADMIN 角色，否则 403；连同评论一并删除")
