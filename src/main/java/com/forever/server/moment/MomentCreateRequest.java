...
public record MomentCreateRequest(
        ...
        @Schema(description = "图片直链列表，最多 9 张；元素为直传接口返回的 accessUrl（RustFS 公开桶直链）")
        @Size(max = 9, message = "图片最多 9 张") List<String> images,
        @Schema(description = "音频直链，最多 1 个") String audio,
        @Schema(description = "视频直链，最多 1 个") String video,
